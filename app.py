...
balance = st.number_input('Estimated Salary')
...
input_data = pd.DataFrame({
    ...
    'EstimatedSalary': [balance]  # Assuming Estimated Salary is the same as Balance
})
...
# Combine one-hot encoded column with input_data
